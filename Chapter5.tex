...
\begin{itemize}
    ...
    \item Tìm được nghiệm thành công.
    \item A* Heuristic 2 là tuyệt vời, nhanh gấp 96 lần so với Forward Chaining, gấp 15 lần so với Heuristic 1. Mở rộng chỉ 37 nodes cho thấy heuristic này rất chính xác.
    \item Thú vị là số node mở rộng bằng với Input-04, cho thấy heuristic 2 tìm được đường dẫn tối ưu ngay lập tức.
\end{itemize}
